...
```mermaid
flowchart TD
    A["MR 過度活化<br/>(aldosterone + 皮質醇 · aldosterone breakthrough)"] --> B["非上皮組織效應<br/>心肌細胞 · podocyte · 內皮 · 纖維母細胞 · 巨噬細胞"]
    B --> C["發炎<br/>M1 巨噬細胞 · IL-1β / IL-6 · NLRP3 · Rac1"]
    B --> D["纖維化<br/>TGF-β · fibronectin · osteopontin"]
    C --> E["腎小球 / 腎小管間質損傷"]
    D --> E
    C --> F["心肌纖維化 / 肥厚"]
    D --> F
