# Finerenone 心腎保護：進階演講題庫（六大主題深度文獻回顧）
...
> [`deep-research-report.md`](deep-research-report.md) 為產生這六個主題的母體研究報告（含各主題完整 面向 brief、試驗/法規里程碑、優先文獻地圖）。

## 涵蓋的核心試驗與分析
ARTS / ARTS-DN / ARTS-HF · FIDELIO-DKD · FIGARO-DKD · FIDELITY(個體層級 pooled) · FINEARTS-HF(HFpEF/HFmrEF) · CONFIDENCE(finerenone+empagliflozin 三臂) · FINE-ONE(T1D) · FIND-CKD(非糖尿病 CKD)+glomerular 亞群 · FINE-HEART pooled(18,991) · INFINITY / 2026 Lancet DM+非DM pooled。
...
- 每篇主文文末以「已核准 / 可外推 / 尚待驗證（surrogate-based）」三層標示證據性質

---
*資料日期基準：2026-07-08。FDA 對 finerenone T1D-CKD 適應症當時僅「受理 Priority Review」，尚非核准。*
