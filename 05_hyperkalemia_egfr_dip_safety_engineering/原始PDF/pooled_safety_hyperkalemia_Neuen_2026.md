...
pmid: "42248158"
source: "Europe PMC (abstract only; is_open_access=False, no PMCID/PDF)"
...
> NOTE: Full text is not open-access (Europe PMC `is_open_access=False`, no PMCID/PDF). The OA-first fallback chain (source-native, OA repos, Unpaywall) returned no full text; the Sci-Hub fallback returned a polluted/unrelated PDF (a Russian reproductive-medicine article, PMID 36128573), which was discarded. Only the publisher/Europe PMC abstract is reproduced below, verified against the target title/authors/DOI/PMID.
...
---
*Source: Europe PMC (PMID:42248158); metadata cross-checked with CrossRef (The Lancet, 2026, vol 407, issue 10546, pp 2375–2386). DOI: 10.1016/S0140-6736(26)01009-3.*
