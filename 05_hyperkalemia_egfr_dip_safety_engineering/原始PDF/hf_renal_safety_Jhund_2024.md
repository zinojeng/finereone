...
authors: "Jhund PS; Talebi A; Henderson AD; Claggett BL; Vaduganathan M; Desai AS; Lam CSP; Pitt B; Senni M; Shah SJ; Voors AA; Zannad F; Solomon SD; McMurray JJV"
year: 2024
journal: "The Lancet"
doi: "10.1016/S0140-6736(24)01733-1"
pmid: "39232490"
source: "Europe PMC (abstract only; full text paywalled, not open access)"
...
**Note:** This article is NOT open access (Europe PMC `is_open_access: False`, no PMCID). Full-text PDF could not be legitimately retrieved via OA chains. The OA fallback downloader repeatedly returned a mismatched/polluted PDF (a Cambridge Prisms mental-health article, PMID 41080663) which was verified as incorrect and discarded. Only the publisher/Europe PMC structured abstract is reproduced below, with metadata (title, all authors, DOI, PMID, year) verified against the task target.
